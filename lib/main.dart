  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 45, 206, 53)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Seminario Flutter'),
    );
  }
}
    ...
    return Scaffold(
      ...
      floatingActionButton: SpeedDial(
        ...
        onTap: _nextLayout,
          ...
          SpeedDialChild(
        child: const Icon(Icons.paid, color: Colors.white),
